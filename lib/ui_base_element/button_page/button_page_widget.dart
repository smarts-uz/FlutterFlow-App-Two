...
import 'button_page_model.dart';
export 'button_page_model.dart';

class ButtonPageWidget extends StatefulWidget {
  const ButtonPageWidget({Key? key}) : super(key: key);
...
class _ButtonPageWidgetState extends State<ButtonPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ButtonPageModel());
  }
