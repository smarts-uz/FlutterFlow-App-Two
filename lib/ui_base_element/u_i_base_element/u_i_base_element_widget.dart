...
import 'u_i_base_element_model.dart';
export 'u_i_base_element_model.dart';

class UIBaseElementWidget extends StatefulWidget {
  const UIBaseElementWidget({Key? key}) : super(key: key);

  @override
  _UIBaseElementWidgetState createState() => _UIBaseElementWidgetState();
}

class _UIBaseElementWidgetState extends State<UIBaseElementWidget> {
  late UIBaseElementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UIBaseElementModel());
  }
