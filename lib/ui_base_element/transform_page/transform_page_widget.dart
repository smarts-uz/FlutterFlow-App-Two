...
import 'transform_page_model.dart';
export 'transform_page_model.dart';

class TransformPageWidget extends StatefulWidget {
  const TransformPageWidget({Key? key}) : super(key: key);

  @override
  _TransformPageWidgetState createState() => _TransformPageWidgetState();
}

class _TransformPageWidgetState extends State<TransformPageWidget>
    with TickerProviderStateMixin {
  late TransformPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransformPageModel());
