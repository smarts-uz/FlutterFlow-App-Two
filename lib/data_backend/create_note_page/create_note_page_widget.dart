...
class _CreateNotePageWidgetState extends State<CreateNotePageWidget> {
  ...
  void initState() {
    ...
    _model.desFieldController ??= TextEditingController();
  }
              ...
              children: [
                ...
                Padding(
                  padding:
                      EdgeInsetsDirectional.fromSTEB(16.0, 16.0, 16.0, 16.0),
                  child: TextFormField(
                    controller: _model.desFieldController,
                    autofocus: true,
                    obscureText: false,
                    decoration: InputDecoration(
                    ...
                    style: FlutterFlowTheme.of(context).bodyMedium,
                    validator:
                        _model.desFieldControllerValidator.asValidator(context),
                  ),
                ),
                Padding(
                  padding:
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      ...
                      await NotesTable().insert({
                        ...
                        'description': _model.desFieldController.text,
                        'id': int.tryParse(_model.idController.text),
                      });
